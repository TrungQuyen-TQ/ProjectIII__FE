...
export default function Header() {
  ...
  // --- DỮ LIỆU MENU CÓ THÊM DANH MỤC CON (META MENU) ---
  const navItems = [
    { 
      label: '🎁 Quà lưu niệm', 
      href: '/qua-luu-niem',
      subItems: ['Đồ Handmade', 'Khung ảnh & Album', 'Móc khóa', 'Gấu bông', 'Quà tặng gỗ', 'Xem tất cả'] 
    },
    { 
      label: '💌 Thiệp chúc mừng', 
      href: '/thiep-chuc-mung',
      subItems: ['Thiệp sinh nhật', 'Thiệp Lễ Tết', 'Thiệp tình yêu', 'Thiệp 3D Pop-up', 'Xem tất cả'] 
    },
    { 
      label: '🎎 Búp bê', 
      href: '/bup-be',
      subItems: ['Búp bê Barbie', 'Búp bê len Amigurumi', 'Búp bê trang trí', 'Phụ kiện búp bê', 'Xem tất cả'] 
    },
    { 
      label: '📁 Cặp tài liệu', 
      href: '/cap-tai-lieu',
      subItems: ['Bìa còng', 'Cặp da công sở', 'Túi clear bag', 'Trình ký', 'Xem tất cả'] 
    },
    { 
      label: '👜 Túi xách', 
      href: '/tui-xach',
      subItems: ['Balo thời trang', 'Túi Tote', 'Túi đeo chéo', 'Ví cầm tay', 'Xem tất cả'] 
    },
    { 
      label: '💄 Mỹ phẩm', 
      href: '/my-pham',
      subItems: ['Son môi', 'Chăm sóc da mặt', 'Trang điểm', 'Dụng cụ makeup', 'Xem tất cả'] 
    },
  ];
  ...
  const drawerContent = (
    <Box sx={{ width: 300, bgcolor: '#ffffff', height: '100%', overflowY: 'auto' }}>
      <Box sx={{ bgcolor: COLORS.headerBg, color: COLORS.headerColor, p: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Box component="img" src="/logo-art-white.svg" alt="Logo" sx={{ height: 40, width: 'auto', filter: 'invert(1)' }} />
        ...
        <Container maxWidth="lg">
          <Box sx={{ display: { xs: 'none', md: 'flex' }, alignItems: 'center', justifyContent: 'space-between', gap: 3 }}>
            ...
            <Link href="/" style={{ textDecoration: 'none', flexShrink: 0, display: 'flex', alignItems: 'center', gap: '10px', marginRight: '24px' }}>
              <Box component="img" src="/logo-art-white.svg" alt="Logo" sx={{ height: 40, width: 'auto', objectFit: 'contain' }} />
            ...
            <Stack direction="row" spacing={1.5} alignItems="center" sx={{ flexShrink: 0 }}>
              <Button component={Link} href="/tracking" startIcon={<LocalShippingIcon sx={{ fontSize: 22 }} />} sx={{ color: COLORS.headerColor, textTransform: 'none', fontWeight: 600, borderRadius: '8px', '&:hover': { bgcolor: 'rgba(255,255,255,0.15)' } }}>Đơn hàng</Button>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '100%' }}>
              <Stack direction="row" spacing={0} alignItems="center">
                ...
                <Link href="/" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  <Typography variant="subtitle1" sx={{ color: 'white', fontWeight: 800, fontSize: '1rem', whiteSpace: 'nowrap' }}>
                    Tạp Hóa Store
                  </Typography>
                </Link>
              </Stack>
